...
class Question(models.Model):
    ...
    # For practice exams, store the expected (ideal) answer for reference/comparison
    expected_answer = models.TextField(blank=True, null=True)
    # Optional: Add extra field for explanations or reference comprehension
    comprehension_reference = models.TextField(blank=True, null=True)
